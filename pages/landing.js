...
const Landing = (props) => {
  ...
  const [postCountStatus, setPostCountStatus] = useState({
    view: 0,
    like: 0,
    share: 0,
    comment: 0,
  ...
  async function loadCommentAction(postid, pageid) {
    try {
      const response = await axios.get(
        SITE_URL + `/loadcomment/${postid}/${pageid}`
      );
    ...
    <>
      ...
      <Layout>
        ...
        <section className="blog-area-two pb-100 rpb-70 rel z-1">
          <div className="container">
            <div className="row align-items-end pb-35"></div>
            <div className="row justify-content-center">
              {post.map((postobj, posti) => (
                <div className="col-xl-4 col-md-4">
                  <div className="blog-item wow-x fadeInUp-x delay-0-2s-x">
                    <div className="image">
                      <img
                        src={postobj.image_path}
                        err="assets/images/blog/blog1.jpg"
                        alt=""
                        height={300}
                      />
                    </div>
                    <div className="content">
                      <h4>
                        <Link
                          href=""
                          key={postobj.id}
                          onClick={() => handleView(event, postobj.id)}
                        >
                          {postobj.title}
                        </Link>
                      </h4>
                      <div className="author-more">
                        <span
                          className="author"
                          onClick={() => handleIncrement(event, postobj.id)}
                        >
                  ...
                  <div className="col-md-4">
                    <div className="modal-body inline">
                      ...
                      <div className="author-more">
                        <span className="author">
                          ...
                          {postCountStatus.like > postDetail.like ? (
                            <span
                              onClick={() =>
                                handleIncrement(event, postDetail.id)
                              }
                            >
                              {postCountStatus.like}
                            </span>
                          ) : (
                            <span
                              onClick={() =>
                      ...
                      {postDetailComment.map((postDetailCommentObj, i) => {
                        return (
                          <>
                            <p>{postDetailCommentObj.comment}</p>
                          </>
                        );
                      })}
